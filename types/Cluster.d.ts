 ...
 */
export declare const Cluster: React.ForwardRefExoticComponent<ClusterProps & React.RefAttributes<any>>;
export interface ClusterProps extends FrameProps {
    readonly display?: never;
    readonly reverse?: boolean;
    readonly gap?: DefaultVars['gap'];
}
export declare const ClusterItem: React.ForwardRefExoticComponent<ClusterItemProps & React.RefAttributes<any>>;
